...
& ".\create_volumes_with_permissions.ps1" "$($env:IRIS_INSTANCE_NAME)-community"

# Start the containers
Write-Host "Starting the containers..."
& docker compose -f docker-compose-community.yml -p "$($env:IRIS_INSTANCE_NAME)-community" up -d
