...
const ENV_MAP: Record<string, { baseUrl: string; oruCfgItem: string; adtCfgItem: string; username: string; password: string; fileDir: string }> = {
  'dev-aws':              { baseUrl: 'http://ec2-63-177-72-122.eu-central-1.compute.amazonaws.com/iris-health-training-dev/csp/healthshare/dglab',  oruCfgItem: 'LAB RESULT from DGLAB - HTTP', adtCfgItem: 'Patient Information from IHE PAM - HTTP', username: '_system', password: 'IRIS4Good/', fileDir: '/dev/data/HL7/ORU/in'  },
  'prod-aws':             { baseUrl: 'http://ec2-63-177-72-122.eu-central-1.compute.amazonaws.com/iris-health-training-prod/csp/healthshare/dglab', oruCfgItem: 'LAB RESULT from DGLAB - HTTP', adtCfgItem: 'Patient Information from IHE PAM - HTTP', username: '_system', password: 'IRIS4Good/', fileDir: '/prod/data/HL7/ORU/in' },
  'dev-local-community':  { baseUrl: 'http://localhost:881/iris-health-training-dev/csp/healthshare/dglab',                                          oruCfgItem: 'LAB RESULT from DGLAB - HTTP', adtCfgItem: 'Patient Information from IHE PAM - HTTP', username: '_system', password: 'SYS',        fileDir: '/dev/data/HL7/ORU/in'  },
  'prod-local-community': { baseUrl: 'http://localhost:881/iris-health-training-prod/csp/healthshare/dglab',                                         oruCfgItem: 'LAB RESULT from DGLAB - HTTP', adtCfgItem: 'Patient Information from IHE PAM - HTTP', username: '_system', password: 'SYS',        fileDir: '/prod/data/HL7/ORU/in' },
  'dev-local':            { baseUrl: 'http://localhost/iris-health-training-dev/csp/healthshare/dglab',                                              oruCfgItem: 'LAB RESULT from DGLAB - HTTP', adtCfgItem: 'Patient Information from IHE PAM - HTTP', username: '_system', password: 'IRIS4Good/', fileDir: '/dev/data/HL7/ORU/in'  },
  'prod-local':           { baseUrl: 'http://localhost/iris-health-training-prod/csp/healthshare/dglab',                                             oruCfgItem: 'LAB RESULT from DGLAB - HTTP', adtCfgItem: 'Patient Information from IHE PAM - HTTP', username: '_system', password: 'IRIS4Good/', fileDir: '/prod/data/HL7/ORU/in' },
};
